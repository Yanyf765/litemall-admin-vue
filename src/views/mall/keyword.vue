...
<div class="app-container">
  ...
  <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
    ...
    <el-table-column align="center" label="操作" width="250" class-name="small-padding fixed-width">
      ...
      <el-button v-permission="['POST /admin/keyword/delete']" type="dangle" size="mini" @click="handleDelete(scope.row)">删除</el-button>
    </el-table-column>
  </el-table>
...
<script>
import {listKeyWord, deleteKeyword, updateKeyword, createKeyword} from '@/api/keyword'
